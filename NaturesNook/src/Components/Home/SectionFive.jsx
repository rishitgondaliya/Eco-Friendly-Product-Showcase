...
function SectionFive() {
    return (
        <>
            <div className="relative w-full h-[22rem] flex items-center justify-center overflow-hidden">
                <img src={bg_image} alt="Background" className="absolute inset-0 object-cover w-full h-full z-[-1] " ></img>
                <div className="h-full container40 raleway-font ">
                    <div className="text-center flex-col justify-center p-4 text-[#493b2f]">
