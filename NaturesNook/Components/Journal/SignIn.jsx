    ...
    <div className="max-w-2xl mx-auto border-2 my-16 bg-gray-400 rounded-lg p-3">
      ...
      <form className="flex flex-col gap-7 mx-3 mt-10">
        ...
        <input
          ...
          required
        />
        <button className="w-full text-lg bg-red-500 p-3 mt-1 rounded-full font-semibold tracking-wide">
          Reset
        </button>
        <button className="w-full text-lg bg-green-700 p-3 mt-1 rounded-full font-semibold tracking-wide">
